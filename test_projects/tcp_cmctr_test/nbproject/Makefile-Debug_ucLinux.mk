...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/PAC/uclinux/tcp_cmctr.o: nbproject/Makefile-${CND_CONF}.mk ../../src/PAC/uclinux/tcp_cmctr.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -w -s -DDEBUG -I../../src/PAC/uclinux/ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/src/PAC/uclinux/tcp_cmctr.o ../../src/PAC/uclinux/tcp_cmctr.cpp

${OBJECTDIR}/main.o: nbproject/Makefile-${CND_CONF}.mk main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -w -s -DDEBUG -I../../src/PAC/uclinux/ -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} dist/Debug_ucLinux/arm-uclinux-elf-Linux-x86/test_tcp_communicator
