...
${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/PAC/common/tcp_cmctr.o: nbproject/Makefile-${CND_CONF}.mk ../../PAC/common/tcp_cmctr.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -Wall -DUSE_NO_TANK_COMB_DEVICE -DDEBUG -DPAC -DW750 -DDEBUG_DEV_CMCTR -I../../PAC/uclinux -I../../PAC/common -I../../common/PAC-driver -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/_DOTDOT/PAC/common/tcp_cmctr.o ../../PAC/common/tcp_cmctr.cpp
