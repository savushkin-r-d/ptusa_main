...
/* MessageType */
static UA_DataTypeMember MessageType_members[8] = {
{
    UA_TYPENAME("ACK") /* .memberName */
...
/* ChunkType */
static UA_DataTypeMember ChunkType_members[3] = {
{
    UA_TYPENAME("FINAL") /* .memberName */
    (const UA_DataType *)0, /* .memberType */
    0, /* .padding */
    false, /* .isArray */
    false /* .isOptional */
...
{
    UA_TYPENAME("INTERMEDIATE") /* .memberName */
    (const UA_DataType *)1, /* .memberType */
    0, /* .padding */
    false, /* .isArray */
    false /* .isOptional */
