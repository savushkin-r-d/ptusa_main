...
TEST( toLuapp, tolua_PAC_dev_get_delta_millisec00 )
    ...
    lua_remove( L, -1 );
    lua_getglobal( L, "dt_0" );
    auto dt_0 = tolua_tonumber( L, -1, 0 );
    lua_remove( L, -1 );
    lua_getglobal( L, "dt_ms" );
