...
TEST( toLuapp, tolua_PAC_dev_AI00 )
	...
	auto AI1 = static_cast<i_AI_device*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_AO00 )
	...
	auto AO1 = static_cast<i_AO_device*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_DI00 )
	...
	auto DI1 = static_cast<i_DI_device*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_DO00 )
	...
	auto DO1 = static_cast<i_DO_device*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_V00 )
	...
	auto V1 = static_cast<valve*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_VC00 )
	...
	auto VC1 = static_cast<i_AO_device*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_M00 )
	...
	auto M1 = static_cast<i_motor*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_LS00 )
	...
	auto LS1 = static_cast<i_DI_device*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_FS00 )
	...
	auto FS1 = static_cast<i_DI_device*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_TE00 )
	...
	lua_getfield( L, LUA_GLOBALSINDEX, "TE1" );
	auto TE1 = static_cast<i_AI_device*>( tolua_touserdata( L, -1, 0 ) );
	EXPECT_NE( nullptr, TE1 );
	lua_remove( L, -1 );
...
TEST( toLuapp, tolua_PAC_dev_LT00 )
	...
	auto LT1 = static_cast<level*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_GS00 )
	...
	auto GS1 = static_cast<i_DI_device*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_HA00 )
	...
	auto HA1 = static_cast<i_DI_device*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_HL00 )
	...
	auto HL1 = static_cast<signal_column*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_HLA00 )
	...
	auto HLA1 = static_cast<signal_column*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_SB00 )
	...
	auto SB1 = static_cast<i_DI_device*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_QT00 )
	...
	auto QT1 = static_cast<i_AI_device*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_PT00 )
	...
	auto PT1 = static_cast<i_AI_device*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_F00 )
	...
	auto F1 = static_cast<i_AI_device*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_EY00 )
	...
	auto EY1 = static_cast<signal_column*>( tolua_touserdata( L, -1, 0 ) );
...
TEST( toLuapp, tolua_PAC_dev_DEVICE00 )
	...
	auto dev1 = static_cast<device*>( tolua_touserdata( L, -1, 0 ) );
