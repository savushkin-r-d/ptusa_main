...
TEST( uni_io_manager, net_init )
    ...
    subhook_t socket_hook = subhook_new( (void*)socket, (void*)fail_socket,
    ...
    subhook_t setsockopt_hook = subhook_new( (void*)setsockopt, (void*)fail_setsockopt,
        SUBHOOK_64BIT_OFFSET );
...
#ifdef WIN_OS
    subhook_t ioctlsocket_hook = subhook_new( (void*)ioctlsocket, (void*)fail_ioctlsocket,
        SUBHOOK_64BIT_OFFSET );
...
#else
    subhook_t fcntl_hook = subhook_new( (void*)fcntl, (void*)fail_fcntl,
        SUBHOOK_64BIT_OFFSET );
    ...
    subhook_t select_m1_hook = subhook_new( (void*)select, (void*)fail_select_m1,
        SUBHOOK_64BIT_OFFSET );
    subhook_install( select_m1_hook );
    // Should fail - fail with select() - 1.
    EXPECT_EQ( 6, mngr.net_init( &node ) );
    subhook_remove( select_m1_hook );
    subhook_t select_0_hook = subhook_new( (void*)select, (void*)fail_select_0,
        SUBHOOK_64BIT_OFFSET );
    ...
    subhook_t getsockopt_1_hook = subhook_new( (void*)getsockopt, (void*)fail_getsockopt,
        SUBHOOK_64BIT_OFFSET );
    subhook_install( getsockopt_1_hook );
    subhook_t select_1_hook = subhook_new( (void*)select, (void*)success_select,
        SUBHOOK_64BIT_OFFSET );
    ...
    subhook_install( select_1_hook );
    subhook_t getsockopt_0_hook = subhook_new( (void*)getsockopt, (void*)success_getsockopt,
        SUBHOOK_64BIT_OFFSET );
