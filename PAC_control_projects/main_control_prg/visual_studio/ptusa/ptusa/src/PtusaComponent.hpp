...
namespace Ptusa
    ...
    //#component
    class PtusaComponent : public ComponentBase, public ProgramComponentBase, private Loggable<PtusaComponent>
        {
        public: // typedefs

        public: // construction/destruction
            PtusaComponent( IApplication& application, const String& name );
            virtual ~PtusaComponent() = default;
        ...
        private: // methods
            PtusaComponent( const PtusaComponent& arg ) = delete;
            PtusaComponent& operator= ( const PtusaComponent& arg ) = delete;

        public: // static factory operations
            static IComponent::Ptr Create( Arp::System::Acf::IApplication& application, const String& name );

        private: // fields
            PtusaComponentProgramProvider programProvider;
    ...
    inline IComponent::Ptr PtusaComponent::Create( Arp::System::Acf::IApplication& application, const String& name )
        {
        return IComponent::Ptr( new PtusaComponent( application, name ) );
        }
