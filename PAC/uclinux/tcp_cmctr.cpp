...
int tcp_communicator::net_init()
	...
	int protocol = 0;        /* ������ 0 */
	int err = master_socket = socket( PF_INET, type, protocol ); // C������� ������-������.
	...
	sst[ modbus_socket ].sin.sin_port 		  = htons ( 502 ); // ����.
	err = bind( modbus_socket, ( struct sockaddr * ) & sst[ modbus_socket ].sin,
	            sizeof ( sst[ modbus_socket ].sin ) );	   // �������� ������.
	if ( err < 0 )
		{
	...
	sst[ master_socket ].active = 1;  	 //������-����� ������ ��������
	sst[ master_socket ].islistener = 1; //����� �������� ����������
