...
///
/// This module uses the handling of the PROFIBUS slave device. That contains
/// starting and stopping of the device functionality as well as the process
/// data exchange between the fieldbus an PLC process data images.
///
...
class profibus_slave_PFC200 : public profibus_slave {
 ...
 public:
  ...
  /// @brief This function is the main loop. It exchanges the process data
  /// between the input an output process images.
  ///
...
class profibus_slave_PFC200 : public profibus_slave {
 public:
  ...
  virtual ~profibus_slave_PFC200() { close(); }
 ...
 private:
  ...
  /// @return - \ref DAL_SUCCESS when the function has successfully
  /// processed. In other cases it returns \ref DAL_FAILURE.
  int32_t get_device_id(size_t ulNrDevicesFound, tDeviceInfo* pastDeviceList,
