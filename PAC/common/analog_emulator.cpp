...
float analog_emulator::get_st_deviation() const { return d.stddev(); }

float analog_emulator::get_m_expec() const { return d.mean(); }
...
float analog_emulator::get_value() { return d(rd); }
