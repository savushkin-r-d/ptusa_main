...
/// всех ошибок служит структура @ref
/// PAC_critical_errors_manager::critical_error.
///
...
class PAC_critical_errors_manager {
 ...
 public:
  ...
  u_int get_id() const { return errors_id; }

  bool is_any_error() const { return !errors.empty(); }

 private:
  static const char* get_alarm_group() { return "Авария"; }
  ...
  struct critical_error {
    ...
    critical_error(int err_class = 0, u_int err_sub_class = 0, u_int param = 0);
  };
