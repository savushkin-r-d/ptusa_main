...
int cipline_tech_object::save_device( char *buff )
    ...
    answer_size += snprintf(buff + answer_size, sizeof(buff), "%s", lineRecipes->get_current_recipe_name());

    //Выбранная программа мойки
    answer_size += sprintf(buff + answer_size, "\tCUR_PRG='%s',\n", currentProgramName);

    //Список доступных программ мойки
    answer_size += snprintf(buff + answer_size, sizeof(buff), "%s", programList.data());

    //Список доступных объектов мойки
    answer_size += snprintf(buff + answer_size, sizeof(buff), "%s", lineRecipes->get_recipe_list());
    ...
    if (nmr == 1)
    {
        ...
        answer_size += snprintf(buff + answer_size, sizeof(buff), "%s", causticRecipes->get_recipe_list());
        ...
        answer_size += snprintf(buff + answer_size, sizeof(buff), "%s", causticRecipes->get_current_recipe_name());
        ...
        answer_size += snprintf(buff + answer_size, sizeof(buff),"%s", acidRecipes->get_recipe_list());
        ...
        answer_size += snprintf(buff + answer_size, sizeof(buff), "%s", acidRecipes->get_current_recipe_name());
