...
class memory_range : public i_memory {
 ...
 public:
  /// @brief Метод интерфейса @ref i_memory.
  u_int get_size() const { return size; }
...
class NV_memory_manager {
 public:
  ...
  virtual memory_range *get_memory_block(MEMORY_TYPE m_type, u_int count);
