...
/* method: instant_on of class  dev_stub */
#ifndef TOLUA_DISABLE_tolua_PAC_dev_dev_stub_instant_on00
static int tolua_PAC_dev_dev_stub_instant_on00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  dev_stub* self = (dev_stub*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'instant_on'",
      NULL);
#endif
  {
   self->instant_on();
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'instant_on'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_PAC_dev_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_beginmodule(tolua_S,"dev_stub");
   ...
   tolua_function(tolua_S,"instant_on",
      tolua_PAC_dev_dev_stub_instant_on00);
