/*
** Lua binding: PAC_dev
** Generated automatically by tolua++-1.0.92 on 05/19/15 16:32:07.
*/
...
/* get function: ncar of class  cipline_tech_object */
#ifndef TOLUA_DISABLE_tolua_get_cipline_tech_object_ncar
static int tolua_get_cipline_tech_object_ncar(lua_State* tolua_S)
{
  cipline_tech_object* self = (cipline_tech_object*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'ncar'",NULL);
#endif
  tolua_pushstring(tolua_S,(const char*)self->ncar);
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: ncar of class  cipline_tech_object */
#ifndef TOLUA_DISABLE_tolua_set_cipline_tech_object_ncar
static int tolua_set_cipline_tech_object_ncar(lua_State* tolua_S)
{
  cipline_tech_object* self = (cipline_tech_object*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  ...
  if (!tolua_isstring(tolua_S,2,0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->ncar = ((char*)  tolua_tostring(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_PAC_dev_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_beginmodule(tolua_S,"cipline_tech_object");
   ...
   tolua_variable(tolua_S,"ncar",tolua_get_cipline_tech_object_ncar,tolua_set_cipline_tech_object_ncar);
