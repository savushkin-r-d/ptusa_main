...
class win_tcp_client: public tcp_client
	...
	public:
		...
		win_tcp_client( const char* client_ip, unsigned int client_port, unsigned int client_id, unsigned char alarm_subclass, unsigned int exchange_buf_size = 256, uint32_t send_receive_timeout = 100 );
