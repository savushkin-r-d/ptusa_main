...
class profibus_slave_PC : public profibus_slave {
 public:
  ...
  static profibus_slave* get_instance() { return instance; }

  virtual double get_double(int offset) { return 0; }

  virtual bool get_bool(int byte_offset, int bit_offset) { return false; }

  virtual void set_bool(int byte_offset, int bit_offset, bool val) {}

  virtual int get_int(int byte_offset) { return 0; }

  virtual void set_int(int byte_offset, int val) {}

  virtual int get_int4(int byte_offset) { return 0; }
